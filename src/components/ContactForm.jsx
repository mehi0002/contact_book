...
function ContactForm(props){
    ...
    return(
        <form>
            ...
            <input type="text" id="fName" name="fName" value={props.firstName} placeholder="first name" onChange={changeHandler}></input>
            
            <label htmlFor="lName">Last Name</label>
            <input type="text" id="lName" name="lName" value={props.lastName} placeholder="last name" onChange={changeHandler}></input>
            ...
            <input type="text" id="pCode" name="pCode" value={props.postalCode} placeholder="A1A 1A1" onChange={changeHandler}></input> 
